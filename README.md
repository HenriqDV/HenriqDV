...
| Projeto | Descrição |
|---|---|
| [Panela Verde](https://github.com/HenriqDV/PanelaVerde) | Site institucional para restaurante fictício vegano — HTML, CSS e Bootstrap 5.3 |
| [Vargas Telhados](https://github.com/HenriqDV/VargasTelhados) | Site de apresentação de serviços de conserto de telhados, com foco em usabilidade |
| [Currículo Virtual](https://henriquedv.tech/) | Página pessoal em HTML/CSS para apresentação profissional online |
